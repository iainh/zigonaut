...
const AttachPane = *const fn (?*anyopaque, u64, win.HWND, ?*anyopaque, u32, u32, u32, u32, u32, u32) callconv(.c) win.HRESULT;
...
pub const Bridge = struct {
    ...
    pub fn attachPane(self: *Bridge, id: u64, terminal: win.HWND, swap_chain: ?*anyopaque, cell_width: u32, cell_height: u32, minimum_width: u32, minimum_height: u32, initial_width: u32, initial_height: u32) bool {
        const instance = self.instance orelse return false;
        return succeeded(self.attach_pane_fn(instance, id, terminal, swap_chain, cell_width, cell_height, minimum_width, minimum_height, initial_width, initial_height));
    }
