...
typedef enum ZigonautScrollTraceEvent {
    ...
    ZIGONAUT_SCROLL_TRACE_KEY_RECEIVED,
    ZIGONAUT_SCROLL_TRACE_PARSER_COMPLETED,
    ZIGONAUT_SCROLL_TRACE_SNAPSHOT_COMPLETED,
    ZIGONAUT_SCROLL_TRACE_NATIVE_RASTER_COMPLETED,
    ZIGONAUT_SCROLL_TRACE_PRESENT_SUBMITTED,
