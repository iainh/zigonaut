...
__declspec(dllexport) HRESULT __cdecl zigonaut_chrome_update(void* bridge, const uint8_t* shell_kinds, uint32_t count, int32_t active_index) ZIGONAUT_NOEXCEPT;
