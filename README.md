...
1. Translate Win32 keyboard and text events into ConPTY input using Ghostty's key encoder.
2. Resize ConPTY and terminal grids from the viewport's measured font cells.
